              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div>
                  ...
                  <p className="text-green-100 mt-1">
                    Visit registered for {patientName}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-8">
              <div className="text-center">
                ...
                <p className="text-xl text-gray-700 mb-8">
                  Patient has been successfully registered for hospital visit
                </p>
                ...
                <div className="bg-gradient-to-br from-green-50 to-teal-50 rounded-xl p-6 mb-8 text-left">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center border-b border-green-100 pb-2">
                      ...
                      <span className="font-semibold text-gray-900">{visitReason}</span>
                    </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8 text-left">
                  ...
                  <ol className="space-y-2 text-sm text-blue-800">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Patient visit has been recorded in the hospital system</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="font-bold">2.</span>
                      <span>Medical staff will be notified of the new patient visit</span>
                    </li>
                    <li className="flex items-start gap-2">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  >
                    Register Another Patient Visit
                  </Link>
                  <Link
                    href="/"
