...
const demos: Demo[] = [
  ...
  },
  {
    ...
    title: "Issue Digital Health Card - Primary Healthcare Center",
    description: "Sunrise Health Initiative serves 47 rural communities across Kwara State with limited internet connectivity. Paper records were lost to floods, fires, and poor storage. When patients traveled to referral hospitals, their medical history was unknown. Now, Community Health Workers issue digital health cards that patients carry in their phones - accessible even offline.",
    ...
    tested: true,
    features: [
      "Works in low/no internet areas",
      "Critical info: blood type, allergies, genotype",
      "Patient-controlled health records",
      "Survives facility closures and disasters",
    ],
  },
  {
    id: "health-kiosk",
    title: "Hospital Check-In Kiosk - Referral Hospital",
    description: "When rural patients arrive at General Hospital Ilorin for referrals, staff previously spent 30+ minutes recreating medical histories. Medication errors from unknown allergies were common. Now patients scan their digital health card at the kiosk - blood type, allergies, and chronic conditions appear instantly, even without calling the issuing PHC.",
    href: "/health/kiosk",
    status: "active",
    icon: "🖥️",
    category: "Healthcare",
    ...
    features: [
      ...
      "No phone calls to issuing facility",
      "Works when rural PHC is offline",
    ],
  },
  {
    id: "medical-fitness",
  ...
  },
  {
    ...
    description: "Register for the 2025 Annual Professional Development Conference with exclusive graduate discounts. Verify your Statement of Results and NYSC Certificate to receive automatic discounts based on class of degree.",
    ...
    tested: true,
    features: [
      "Conference registration with graduate discounts",
      "Instant credential verification",
      "Class of degree-based pricing (up to 30% off)",
  ...
  },
  {
    ...
    title: "Mandatory Training Compliance - Employer Portal",
    description: "Atlantic Energy Nigeria struggled with tracking 2,500+ offshore workers' mandatory safety certifications across multiple training providers. After a near-miss incident exposed gaps in their paper-based system, they adopted DLT-based verifiable credentials. Now HR instantly verifies worker certifications before site deployment.",
    ...
    tested: true,
    features: [
      "Instant mandatory training verification",
      "Prevent non-compliant site deployments",
      "Multi-provider certification tracking",
      "Regulatory audit trail",
    ],
  },
  {
    id: "training-issue-certification",
    title: "Safety Training Certification - Training Provider Portal",
    description: "NSITF-accredited training providers like SafetyFirst Academy issue tamper-proof digital certifications to workers completing mandatory courses (HUET, Fire Safety, First Aid, H2S). Credentials are cryptographically signed and sent directly to workers' digital wallets, eliminating fake certificates.",
    ...
    tested: true,
    features: [
      "Issue NSITF-compliant certifications",
